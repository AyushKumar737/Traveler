...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="col-sm-12 col-xl-6" style="width:1230px; margin: 30px;">
                <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>" . $row["email"] . "</td>
                                        <td>" . $row["mobile"] . "</td>
                                        <td><a class='btn btn-danger btn-sm' href='admin-table-package-delete.php?p_id=$row[p_id]'>Delete</a></td>
                                    </tr>";
                            }
                            ?>
                        </tbody>
