                 ...
                 <!--<div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4"> -->
                            ...
                            // $sql = "INSERT INTO `add_package`(`package name`, `images`, `description`) VALUES ('$pname','$pimage','$pdesc')";
                            // $stmt = mysqli_stmt_init($conn);
                            // $preparestmt = mysqli_stmt_prepare($stmt,$sql);
                            // if($preparestmt)
                            // {
                            // 	mysqli_stmt_bind_param($stmt, "ss", $pname, $pdesc, $pimage);
                    ...
                    <div class="col-sm-12 col-xl-6" style="margin-bottom: 250px;">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            ?>
                                    ...
                                    <input type="text" name="place" value="<?= $row['place'] ?>" class="form-control" id="inputEmail3">

                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">Enter days</label>
                                    <input type="text" name="days" value="<?= $row['days'] ?>" class="form-control" id="inputEmail3">

                                </div>
                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Image 1</label>
                                    <input class="form-control bg-dark" value="<?= $row['image1'] ?>" name="image1" type="file" id="formFileMultiple" multiple>
                                </div>
                                <div class="mb-3">

                                    <label for="packagename" class="form-label">name 1</label>
                                    <input type="text" name="name1" value="<?= $row['name1'] ?>" class="form-control" id="inputEmail3">

                                </div>
                                <div class="mb-3">

                                    <label for="packagename" class="form-label">Description 1</label>
                                    <input type="text" value="<?= $row['description1'] ?>" name="desc1" class="form-control" id="inputEmail3">

                                </div>
                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Image 2</label>
                                    <input class="form-control bg-dark" value="<?= $row['image2'] ?>"  name="image2" type="file" id="formFileMultiple" multiple>
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">name 2</label>
                                    <input type="text" name="name2" value="<?= $row['name2'] ?>" class="form-control" id="inputEmail3">
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">Description 2</label>
                                    <input type="text" value="<?= $row['description2'] ?>" name="desc2" class="form-control" id="inputEmail3">
                                </div>

                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Image 3</label>
                                    <input class="form-control bg-dark" value="<?= $row['image3'] ?>"  name="image3" type="file" id="formFileMultiple" multiple>
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">name 3</label>
                                    <input type="text" name="name3" value="<?= $row['name3'] ?>" class="form-control" id="inputEmail3">
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">Description 3</label>
                                    <input type="text" value="<?= $row['description3'] ?>" name="desc3" class="form-control" id="inputEmail3">
                                </div>

                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Image 4</label>
                                    <input class="form-control bg-dark"value="<?= $row['image4'] ?>"   name="image4" type="file" id="formFileMultiple" multiple>
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">name 4</label>
                                    <input type="text" name="name4" value="<?= $row['name4'] ?>" class="form-control" id="inputEmail3">
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">Description 4</label>
                                    <input type="text" value="<?= $row['description4'] ?>" name="desc4" class="form-control" id="inputEmail3">
                                </div>

                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Image 5</label>
                                    <input class="form-control bg-dark" value="<?= $row['image5'] ?>"  name="image5" type="file" id="formFileMultiple" multiple>
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">name 5</label>
                                    <input type="text" name="name5" value="<?= $row['name5'] ?>" class="form-control" id="inputEmail3">
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">Description 5</label>
                                    <input type="text" value="<?= $row['description5'] ?>" name="desc5" class="form-control" id="inputEmail3">
                                </div>

                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Image 6</label>
                                    <input class="form-control bg-dark" value="<?= $row['image6'] ?>"  name="image6" type="file" id="formFileMultiple" multiple>
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">name 6</label>
                                    <input type="text" value="<?= $row['name6'] ?>" name="name6" class="form-control" id="inputEmail3">
                                </div>
                                <div class="mb-3">
                                    <label for="packagename" class="form-label">Description 6</label>
                                    <input type="text" value="<?= $row['description6'] ?>" name="desc6" class="form-control" id="inputEmail3">
                                </div>
