...
//     $pname = mysqli_real_escape_string($conn, $_POST['Username']);
//     $pass = $_POST['Password'];

//     $select_admin_name = mysqli_query($conn, "SELECT Username FROM `admin` WHERE Username = '$pname'") or die('query failed');

//     if (mysqli_num_rows($select_admin_name) > 0) {
//         $message[] = 'Admin name already added';
//     } else {
//         $add_admin_query = mysqli_query($conn, "INSERT INTO `admin`(Username, Password ) VALUES('$pname', '$pass' )") or die('query failed');
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Ayush</span>
                        </a>
...
?>
            <div class="container-fluid pt-4 px-4">
                  <div class="col-sm-12 col-xl-6">
                    ...
                    <!-- Footer Start -->
                    <div class="container-fluid pt-4 px-4" style="margin-top:335px;">
