        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="admin-widget.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Widgets</a>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="#">Ayush Kumar</a>
                            <br>Distributed By: <a href="#" target="_blank">TRAVELER</a>
                        </div>
                    </div>
                </div>
            </div>
