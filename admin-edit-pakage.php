                            ...
                            ?>
                             ...
                             <form action="admin_package_add.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc1" class="form-control" id="inputEmail3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc2" class="form-control" id="inputEmail3">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc3" class="form-control" id="inputEmail3">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc4" class="form-control" id="inputEmail3">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc5" class="form-control" id="inputEmail3">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="desc6" class="form-control" id="inputEmail3">
                                </div>
