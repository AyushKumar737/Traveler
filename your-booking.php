            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="your-booking.php" class="nav-item nav-link active"><i class="fa-solid fa-address-card" style="margin-right:5px;"></i>Your Booking</a>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h1 class="text-primary text-uppercase" style="letter-spacing: 5px;">Your Booking</h1>
            </div>
            <div class="row">
                <?php
                ...
                if (isset($_SESSION['id'])) {
                    $id = $_SESSION['id'];
                    $query = "SELECT * FROM package_booking where user_id=" . $_SESSION['id'];
                                ...
                                <div class="package-item bg-white mb-2 your-booking">
                                    <form action="user_booking_edit.php" id="contactForm" name="contactForm" class="contactForm" onsubmit="sendemail ">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="label" for="email" style="margin-left:10px;">Amount</label>
                                                    <input type="email" class="form-control" name="email" id="email" placeholder="Amount" value="" style="border-radius:20px;">
                                                </div>
                                            </div> -->
                                        </div>
                                    </form>
