...
<body>
	<!-- <a href="E:\PROJECT\main\index.html"><i class="fa-solid fa-house"></i></a> -->
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse"  style="height:90px;">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="guest-user-package.php" class="nav-item nav-link"><i class="fa-solid fa-earth-asia" style="margin-right:5px;"></i>Tour Packages</a>
                        ...
                        <a href="Querry.php" class="nav-item nav-link active"><i class="fa-solid fa-person-circle-question" style="margin-right:5px;"></i>Querry</a>
                    </div>
                </div>
            </nav>
        </div>
									...
									<div class="row mb-4">
										<div class="col-md-4">
											<div class="dbox w-100 d-flex align-items-start">
												<div class="text">
													<p><span>Address:</span> Ampics Ganpat University Gujarat</p>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="dbox w-100 d-flex align-items-start">
												<div class="text">
													<p><span>Email:</span> <a href="mailto:info@yoursite.com">Ayush@gmail.com</a></p>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="dbox w-100 d-flex align-items-start">
												<div class="text">
													<p><span>Phone:</span> <a href="tel://1234567920">+91 7376468331</a></p>
												</div>
											</div>
										</div>
									</div>
